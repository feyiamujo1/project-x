  ...
  return (
    <div className='w-full space-y-6'>
        ...
        <div className='bg-white w-full rounded-xl shadow-md space-y-6 py-6'>
            ...
            <div className='w-full p-0 m-0 pr-5 box-border text-xs md:text-base'>
            <ResponsiveContainer className="w-full p-0 px-2.5 md:pl-0 md:pr-4 m-0 box-border"  aspect={window.innerWidth < 640 ? 2 : window.innerWidth >= 640 && window.innerWidth < 768 ? 2 : 3}>
                ...
                {window.innerWidth < 768 ? "" : <YAxis stroke ="#000000" />}
        ...
        <div className='bg-white w-full rounded-xl shadow-md space-y-6 p-6'>
            <div>
            ...
            <div className='w-full p-0 m-0 box-border text-xs md:text-base'>
            <ResponsiveContainer className="w-full p-0 pr-4 m-0 " aspect={window.innerWidth < 640 ? 1 : window.innerWidth >= 640 && window.innerWidth < 768 ? 2 : 2.3} >
                <BarChart
                data={barChartData}
                margin={window.innerWidth >= 768 ? {
                    top: 5,
                    ...
                    left: -20,
                    bottom: 5,
                } : {top:5, bottom:5, left:-30,  right:0}}
                >
                        ...
                        <div className="overflow-hidden">
                            <table className="w-full box-border md:min-w-full text-left">
                                <thead className="border-b bg-[#152a3b] text-black">
                                    ...
                                    <th className="text-sm font-medium px-4 md:px-0 text-white py-4">
                                ...
                                <tbody>
                                    ...
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">1</td>
                                    ...
                                    <td className="text-sm text-black  px-4 md:px-1 py-4 whitespace-nowrap">
                                        Feb 18, 2022
                                    </td>
                                    ...
                                    <tr className="bg-white border-b">
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">2</td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        Billboard
                                    </td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                    ...
                                    <tr className="bg-white border-b">
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">3</td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        Fence Drape
                                    </td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                    ...
                                    <tr className="bg-white border-b">
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">4</td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        Murals
                                    </td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                    ...
                                    <tr className="bg-white border-b">
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">5</td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        Lampost
                                    </td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                    ...
                                    <tr className="bg-white border-b">
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">6</td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        Bridge Panels
                                    </td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                    ...
                                    <tr className="bg-white border-b">
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">7</td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        LED
                                    </td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 md:whitespace-nowrap">
                                        Ebute Meta, Lagos
                                    </td>
                                    <td className="text-sm  text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        12Mx12M
                                    ...
                                    <tr className="bg-white border-b">
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">8</td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        Gantry
                                    </td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                    ...
                                    <tr className="bg-white border-b">
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">9</td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        Bus Shelter
                                    </td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                    ...
                                    <tr className="bg-white border-b">
                                    <td className=" py-4 whitespace-nowrap text-sm font-medium text-black text-center px-4 md:px-1">10</td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 whitespace-nowrap">
                                        Wallwrap
                                    </td>
                                    <td className="text-sm text-black px-4 md:px-2 py-4 md:whitespace-nowrap">
