    ...
    <nav className="absolute top-0 w-full">
        <div className='w-11/12 lg:w-[85%] mx-auto py-4 flex items-center justify-between font-medium '>
            ...
            <ul id='sidebar' className='absolute top-0 right-0 w-[0%] h-screen overflow-hidden transition-multiple ease-in-out bg-white text-black z-10 space-y-10 md:space-y-0 text-left md:text-center  text-lg flex md:text-white md:bg-transparent md:h-fit md:flex md:w-fit md:bg-none md:relative md:z-0 md:overflow-hidden flex-col md:flex-row md:gap-8 cursor-pointer md:text-sm'>
                ...
                <li className='active:text-custom-blue md:hover:text-custom-blue pl-6 md:pr-0 flex items-center gap-[22px] group'>
                    <svg className='w-5 h-5 p-0 block fill-black group-active:fill-custom-blue md:hidden' xmlns="http://www.w3.org/2000/svg" data-name="Flat Color" viewBox="0 0 24 24">
                ...
                <li className='active:text-custom-blue md:hover:text-custom-blue pl-6 md:pr-0 flex items-center box-border gap-4 group'>
                    <svg className='w-6 h-4 p-0 block fill-black group-active:fill-custom-blue md:hidden' xmlns="http://www.w3.org/2000/svg">
                ...
                <li className='active:text-custom-blue md:hover:text-custom-blue pl-6 md:pr-0 flex items-center box-border gap-4 group'>
                    <svg className='w-6 p-0 block fill-black group-active:fill-custom-blue md:hidden' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
