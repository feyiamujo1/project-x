  ...
  return (
    <nav className="absolute top-0 w-full">
        <div className='w-11/12 lg:w-[85%] md:border-b md:border-b-[#FFFFFF4D] mx-auto py-4 md:py-0 flex items-center justify-between font-medium '>
            ...
            <ul id='sidebar' className='absolute top-0 right-0 w-[0%] h-screen overflow-hidden transition-multiple ease-in-out bg-black text-white z-10 space-y-10 md:space-y-0 text-left md:text-center  text-lg flex  md:bg-transparent md:h-fit md:flex md:w-fit md:bg-none md:relative md:z-0 md:overflow-hidden flex-col md:flex-row md:gap-8 md:text-sm'>
                ...
                <li className='active:text-custom-blue  pl-6 md:pt-[33px] md:pb-7 md:px-0 flex items-center gap-[22px] group md:border-b-[5px] md:border-transparent hover:border-custom-blue cursor-pointer'>
                ...
                <li className='active:text-custom-blue  pl-6 md:pt-[33px] md:pb-7 md:px-0 flex items-center gap-4 group md:border-b-[5px] md:border-transparent hover:border-custom-blue cursor-pointer '>
