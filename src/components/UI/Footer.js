  ...
  return (
    <div className={path === "/" ? 'py-14 bg-black' : 'py-14 bg-[#1E1E1E]'}>
        <div className='w-11/12 lg:w-[80%] mx-auto space-y-10 text-white'>
            <div className="grid md:grid-cols-3 space-y-6">
                <h1 
                    ...
                    className="font-extrabold text-5xl">Hello.</h1>
                <div className=''>
                    <div className='space-y-6 md:w-[160px] md:mx-auto'>
                        <Link to="/" 
                            data-aos="fade-up" 
                            data-aos-duration="1000" 
                            className='flex flex-row gap-5 items-center md:items-center group cursor-pointer md:w-fit box-border'>
                        ...
                        <Link to="/redirect" 
                            data-aos="fade-up" 
                            data-aos-duration="1000" 
                            className='flex flex-row gap-4 items-center md:items-center group cursor-pointer md:w-fit'>
                        ...
                        <Link to='/our-services' 
                            data-aos="fade-up" 
                            data-aos-duration="1000" 
                            className='flex flex-row gap-4 items-start md:items-start group cursor-pointer md:w-fit'>
                        ...
                        <Link to='/blog' 
                            data-aos="fade-up" 
                            data-aos-duration="1000" 
                            className='flex flex-row gap-[17px] items-start md:items-center group cursor-pointer md:w-fit'>
                        ...
                        <Link to='/about-us' 
                            data-aos="fade-up" 
                            data-aos-duration="1000" 
                            className='flex flex-row gap-4 items-center md:items-center group cursor-pointer md:w-fit stubborn'>
                ...
                <div className='md:text-right md:space-y-4 space-y-8'>
                    ...
                    <div className='flex flex-row items-center md:justify-end space-x-4'>
                        <IgIcon 
                            data-aos="fade-up" 
                            data-aos-duration="1000"
                            className='w-6 h-6 fill-white active:fill-custom-blue md:hover:fill-custom-blue cursor-pointer ' />
                        <FbIcon 
                            data-aos="fade-up" 
                            data-aos-duration="1000" 
                            className='w-6 h-6 fill-white active:fill-custom-blue md:hover:fill-custom-blue cursor-pointer'/>
                        <LinkedInIcon 
                            data-aos="fade-up" 
                            data-aos-duration="1000"
                            className='w-5 h-5 fill-white active:fill-custom-blue md:hover:fill-custom-blue cursor-pointer' />
                    </div>
                </div>
            </div>
        ...
        <div 
            data-aos="fade-up" 
            data-aos-duration="1000"
            className='pt-14 w-11/12 lg:w-[85%] mx-auto'>
