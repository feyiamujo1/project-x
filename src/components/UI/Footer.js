            ...
            <div className="grid md:grid-cols-3 space-y-6">
                ...
                <div className=''>
                    <div className='space-y-6 md:w-[160px] md:mx-auto'>
                        <div className='flex flex-row gap-5 items-start md:items-center group cursor-pointer md:w-fit box-border'>
                        ...
                        <div className='flex flex-row gap-4 items-start md:items-center group cursor-pointer md:w-fit'>
                        ...
                        <div className='flex flex-row gap-4 items-start md:items-start group cursor-pointer md:w-fit'>
                        ...
                        <div className='flex flex-row gap-[17px] items-start md:items-center group cursor-pointer md:w-fit'>
                        ...
                        <div className='flex flex-row gap-4 items-center md:items-center group cursor-pointer md:w-fit'>
                            <svg className='w-6 h-4 p-0 block fill-white group-active:fill-custom-blue md:group-hover:fill-custom-blue' xmlns="http://www.w3.org/2000/svg">
