    ...
    <div className="py-14 bg-black">
        <div className='w-11/12 lg:w-[85%] mx-auto space-y-10 text-white'>
            <div className="grid md:grid-cols-3 space-y-6">
                ...
                <div className=''>
                    <div className='space-y-6 md:w-[160px] md:mx-auto'>
                        <div className='flex flex-row gap-5 items-start md:items-center group cursor-pointer'>
                            ...
                            <p className='group-active:text-custom-blue md:group-hover:text-custom-blue'>Home</p>
                        </div>
                        <div className='flex flex-row gap-4 items-start md:items-center group cursor-pointer'>
                        ...
                        <div className='flex flex-row gap-4 items-start md:items-start group cursor-pointer'>
                        ...
                        <div className='flex flex-row gap-[17px] items-start md:items-center group cursor-pointer'>
                            ...
                            <p className='group-active:text-custom-blue md:group-hover:text-custom-blue'>Blog</p>
                        </div>
                        <div className='flex flex-row gap-4 items-center md:items-center group cursor-pointer'>
                            <svg className='w-6 h-4 p-0 block fill-white group-active:fill-custom-blue md:group-hover:fill-custom-blue' xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='space-y-4'>
                ...
                <div className='flex flex-row gap-6 items-center group cursor-pointer'>
