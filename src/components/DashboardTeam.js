                      ...
                      <tbody>
                        {
                          TeamMembers.map((teamMember, i) => (
                            <tr key={i} className="bg-white border-b">
                              ...
                              <td className="text-sm text-black px-6  md:px-2 py-4 whitespace-nowrap flex flex-row items-center gap-2">
                                <img src={teamMember.image} className="w-[50px] h-[50px] whitespace-nowrap rounded-full object-contain object-top bg-custom-brown" alt=''/>
                                <div>
                                  <p>{teamMember.name}</p>
                                  {/* <p className='text-custom-brown lowercase'>{teamMember.name.split(/\s+/).splice(0, 1)}@eyekontact.com.ng</p> */}
                                </div>
                              </td>
                              <td className="text-sm text-black  px-6  md:px-2 py-4 whitespace-nowrap">
                                {teamMember.position}
                              </td>
