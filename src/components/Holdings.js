        ...
        <div ref={firstContainer} className="w-11/12 lg:w-[80%] pb-16 pt-[55px] space-y-10 mx-auto">
            <div className='space-y-4 py-5 px-4'>
                ...
                <form 
                    ...
                    <button type='submit' className='bg-custom-blue font-semibold sm:col-start-2 md:col-auto rounded-xl text-base py-3 px-4 space-y-2 hover:bg-custom-brown'>
                        Filter
                    </button>
                </form>
            </div>
            <div 
                ...
                <div 
                    ...
                    <p onClick={() => {setShowAvailable(true)}} className={ showAvailable ? 'text-black py-2.5 px-4 bg-custom-blue-dark cursor-pointer font-medium rounded-l-md' : 'text-white p-2.5 cursor-pointer py-2.5 px-4 hover:text-white  font-medium opacity-50 hover:opacity-100 bg-[#4d4d4d] hover:bg-transparent'}>Available</p>
                    <p onClick={() => {setShowAvailable(false)}} className={ showAvailable ?  'text-white p-2.5 cursor-pointer py-2.5 px-4  font-medium opacity-50 hover:opacity-100 rounded-r-md bg-[#4d4d4d] hover:bg-transparent' : 'text-black py-2.5 px-4 bg-custom-blue-dark cursor-pointer font-medium'}>Deployed</p>
                </div>
            </div>
