            ...
            <div className="w-11/12 lg:w-[80%] mx-auto min-h-[90vh] md:min-h-screen relative pb-16 pt-16 space-y-10 flex flex-col md:justify-between md:flex-row">
                <div className='space-y-10 md:w-[48%]'>
                    ...
                    <div className='space-y-5'>
                        ...
                        <div className='space-y-5'>
                            ...
                            <div className=' flex flex-row w-fit gap-5 items-center group cursor-pointer' >
                ...
                <div className='w-full md:w-[50%]'>
                    <form className='w-full'>
                        ...
                        <div className='relative w-full mb-[20px] box-border'>
                        ...
                        <input className='w-full py-3 border-none outline-none text-white bg-custom-blue-dark cursor-pointer rounded' type="button" id='send_message_button' value="Send Message"/>
                    </form>
                </div>
            </div>
        </div>
