    ...
    <div className='bg-black pb-8 scroll-smooth'>
        ...
        <div className='relative'>
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-14 border-b border-[#acacac4e] relative z-10'>
                <h2 className='text-center text-custom-blue-dark font-bold text-3xl md:text-right'>Media Planning</h2>
        ...
        <div className='relative'>
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-14 border-b border-[#acacac4e] relative z-10'>
                <h2 className='text-center text-custom-blue-dark font-bold text-3xl md:text-right'>Media Buying</h2>
                <div className='flex flex-col-reverse md:flex-row gap-6 md:gap-8 lg:gap-16'>
        ...
        <div className='relative'>
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-14 border-b border-[#acacac4e] relative z-10'>
                <h2 className='text-center text-custom-blue-dark font-bold text-3xl md:text-right'>Creative Design</h2>
                <div className='flex flex-col-reverse md:flex-row gap-6 md:gap-8 lg:gap-16'>
                    <p className='text-white md:text-justify leading-8'>
