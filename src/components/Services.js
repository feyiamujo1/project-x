    ...
    <div className='bg-black pb-8 scroll-smooth'>
            ...
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-10 border-b-[0.1px] border-[#acacac4e]'>
                ...
                <div className='flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-16'>
                    <img
                        ...
                        data-aos-duration="1000" 
                        data-aos-delay="500"
                        className='w-full md:w-[310px] lg:w-[360px]' src={Service1Image} alt="" />
                    <p 
                        data-aos="fade-left" 
                        data-aos-duration="1000"
                        data-aos-delay="500"
                        className='text-white leading-8 md:text-justify' >
        ...
        <div className='relative'>
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-14 border-b border-[#acacac4e] relative z-10'>
                ...
                <div className='flex flex-col-reverse md:flex-row gap-6 md:gap-8 lg:gap-16'>
                    <p 
                        data-aos="fade-right" 
                        data-aos-duration="1000" 
                        data-aos-delay="500"
                    ...
                    <img 
                        ...
                        data-aos-duration="1000" 
                        data-aos-delay="500"
                        className='w-full md:w-[310px] lg:w-[360px]' src={Service2Image} alt="" />
                </div>
            </div>
            ...
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-14 border-b border-[#acacac4e]'>
                ...
                <div className='flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-16'>
                    <img 
                        ...
                        data-aos-duration="1000" 
                        data-aos-delay="500"
                        className='w-full md:w-[310px] lg:w-[360px]' src={Service3Image} alt="" />
                    <p 
                        data-aos="fade-left" 
                        data-aos-duration="1000" 
                        data-aos-delay="500"
            ...
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-14 border-b border-[#acacac4e] relative z-10'>
                ...
                <div className='flex flex-col-reverse md:flex-row gap-6 md:gap-8 lg:gap-16'>
                    <p 
                        ...
                        data-aos-duration="1000" 
                        data-aos-delay="500"
                        className='text-white md:text-justify leading-8'>
                    ...
                    <img 
                        ...
                        data-aos-duration="1000" 
                        data-aos-delay="500"
                        className='w-full md:w-[310px] lg:w-[360px]' src={Service4Image} alt="" />
                </div>
            </div>
            <div className='h-[90%] w-full bg-[#1E1E1E] absolute z-[8] top-0 bottom-0 left-0 right-0 m-auto'></div>
        </div>
            ...
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-14 border-b border-[#acacac4e]'>
                ...
                <div className='flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-16'>
                    <img 
                        ...
                        data-aos-duration="1000" 
                        data-aos-delay="500"
                        className='w-full md:w-[310px] lg:w-[360px]' src={Service5Image} alt="" />
                    <p 
                        data-aos="fade-left" 
                        data-aos-duration="1000" 
                        data-aos-delay="500"
            ...
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-14 border-b border-[#acacac4e] relative z-10'>
                ...
                <div className='flex flex-col-reverse md:flex-row gap-6 md:gap-8 lg:gap-16'>
                    ...
                    <img 
                        ...
                        data-aos-duration="1000" 
                        data-aos-delay="500"
                        className='w-full md:w-[310px] lg:w-[360px]' src={Service6Image} alt="" />
                </div>
            </div>
            <div className='h-[90%] w-full bg-[#1E1E1E] absolute z-[8] top-0 bottom-0 left-0 right-0 m-auto'></div>
        </div>
            ...
            <div className='space-y-10 w-11/12 lg:w-[80%] mx-auto py-14 border-b border-[#acacac4e]'>
                ...
                <div className='flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-16'>
                    <img 
                        ...
                        data-aos-duration="1000" 
                        data-aos-delay="500"
                        className='w-full md:w-[310px] lg:w-[360px]' src={Service7Image} alt="" />
                    <p 
                        data-aos="fade-left" 
                        data-aos-duration="1000" 
                        data-aos-delay="500"
